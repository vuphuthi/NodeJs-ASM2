...
const UserLayout = () => {
    ...
    return <>
        <div className="mx-auto">
            <header className='bg-[#D70018] border-gray-200 dark:bg-gray-900'>
      ...
      <p className="text-white pt-3 pl-5">Xin chào: {user && user.name}</p>
            ...
            {/* Content */}
            <Outlet />
            <footer className="bg-neutral-100 text-center text-neutral-600 mt-[30px] dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="flex items-center justify-center md:justify-start">
                ...
                Điện thoại : 028.7108.8888
              </p>
            </div>
          </div>
        </div>
        <div>
            <img src="/dienthoaivui.png" className="m-auto pb-4" alt="" />
        </div>
